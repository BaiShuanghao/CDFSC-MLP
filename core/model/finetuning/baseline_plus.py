...
class DistLinear(nn.Module):
    ...
    def __init__(self, in_channel, out_channel):
        ...
        self.fc = nn.Linear(in_channel, out_channel, bias=False)    # 用于将输入的 x 映射到输出的类别中心向量
        # See the issue#4&8 in the github
        self.class_wise_learnable_norm = True   # 如果 self.class_wise_learnable_norm 为 True，则使用类别范数来归一化，否则使用全局范数
...
class BaselinePlus(FinetuningModel):
    ...
    def set_forward_vis(self, batch):
        """
        :param batch:
        :return:
        """
